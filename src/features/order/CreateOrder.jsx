    ...
    <div className="px-4 py-6"> 
      <h2 className="text-xl font-semibold mb-8" >Ready  to  order? Let's  go!</h2>
        ...
        <div className="flex flex-col gap-2">
          ...
          <input type="text" name="customer" className="input w-auto" value={username} required />
        </div>
        ...
        <div className="flex flex-col gap-2">
          <label>Address</label>
          <input className="input w-auto" type="text" name="address" required />
        </div>
        ...
        <div>
          ...
          <Button type="small" disabled={isSubmitting}>{isSubmitting ? "placing Order..." : `Order now ${formatCurrency(totalPrice)}`}</Button>
        </div>
       </Form>
